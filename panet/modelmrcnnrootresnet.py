...
def resnet_graph(input_image,architecture="resnet50",stage5=False, train_bn=True):
    ...
    x = KL.Conv2D(64, (3, 3), strides=(1, 1),name='conv1',  use_bias=False)(x)
    x = BatchNorm(name='bn_conv1')(x, training=train_bn)
    x = KL.Activation('relu')(x)
    
    x = KL.ZeroPadding2D((1, 1))(x)
    
    x = KL.Conv2D(64, (3, 3), strides=(1, 1),name='conv2', use_bias=False)(x)
    x = BatchNorm(name='bn_conv2')(x, training=train_bn)
    x = KL.Activation('relu')(x)

    x = KL.ZeroPadding2D((1, 1))(x)
    
    x = KL.Conv2D(64, (3, 3), strides=(1, 1),name='conv3', use_bias=False)(x)
